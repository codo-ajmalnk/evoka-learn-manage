              ...
              <CardContent>
                <div className="grid grid-cols-3 gap-4 mb-6">
                  <div className="text-center">
                    <p className="text-2xl font-bold text-primary">₹{student.totalFees.toLocaleString()}</p>
                    <p className="text-sm text-muted-foreground">Total Fees</p>
                  </div>
                  <div className="text-center">
                    <p className="text-2xl font-bold text-success">₹{student.paidFees.toLocaleString()}</p>
                    <p className="text-sm text-muted-foreground">Paid</p>
                  </div>
                  <div className="text-center">
                    <p className="text-2xl font-bold text-destructive">₹{student.pendingFees.toLocaleString()}</p>
                ...
                <p className="text-center text-sm text-muted-foreground mt-2">
                  {Math.round((student.paidFees / student.totalFees) * 100)}% Completed
                </p>
              </CardContent>
            </Card>
          </TabsContent>
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-2 gap-4 mb-6">
                  ...
                  <div className="text-center">
                    <p className="text-2xl font-bold text-warning">{student.pendingAssignments}</p>
                    <p className="text-sm text-muted-foreground">Pending</p>
                  </div>
                </div>
                ...
                <div className="w-full bg-muted rounded-full h-2">
                  <div 
                    ...
                    style={{ width: `${((student.assignments - student.pendingAssignments) / student.assignments) * 100}%` }}
                  ></div>
                </div>
                <p className="text-center text-sm text-muted-foreground mt-2">
                  {Math.round(((student.assignments - student.pendingAssignments) / student.assignments) * 100)}% Completed
                </p>
              </CardContent>
            </Card>
          </TabsContent>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  <div>
                    <label className="text-sm font-medium text-muted-foreground">Current Batch</label>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-center mb-6">
                  <p className="text-3xl font-bold text-primary">{student.attendanceRate}%</p>
                ...
                <TableRow key={student.id}>
                  ...
                  <TableCell>
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-muted-foreground">WhatsApp: {student.whatsapp}</p>
                    </div>
                  </TableCell>
                  <TableCell>{student.batch}</TableCell>
                  <TableCell>
                    <div className="space-y-1">
                      <p className="text-sm">₹{student.paidFees.toLocaleString()} / ₹{student.totalFees.toLocaleString()}</p>
                  ...
                  <TableCell>
                    <Badge variant={student.attendanceRate > 90 ? "default" : student.attendanceRate > 75 ? "secondary" : "destructive"}>
