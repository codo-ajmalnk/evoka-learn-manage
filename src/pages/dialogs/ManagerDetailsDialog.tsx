...
const ManagerDetailsDialog = memo(({ manager }: ManagerDetailsDialogProps) => {
  return (
    <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
      ...
      <Tabs defaultValue="personal" className="w-full">
        ...
        <TabsContent value="tasks" className="space-y-4">
          ...
          <TasksDashboard userId={manager.id} />
        </TabsContent>
      </Tabs>
    </DialogContent>
  );
...
ManagerDetailsDialog.displayName = "ManagerDetailsDialog";
