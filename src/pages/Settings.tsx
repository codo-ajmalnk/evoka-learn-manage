...
import { Plus, Edit, Trash2, Book, GraduationCap, Users, DollarSign, Tag, Percent, Search } from 'lucide-react';
  ...
  const handleSave = () => {
    ...
    switch (dialogType) {
      case 'course':
        ...
        if (editingItem) {
          setCoursesData(prev => prev.map(item => item.id === editingItem.id ? courseItem : item));
        } else {
      ...
      case 'syllabus':
        ...
        if (editingItem) {
          setSyllabiData(prev => prev.map(item => item.id === editingItem.id ? syllabusItem : item));
        } else {
      ...
      case 'batch':
        ...
        if (editingItem) {
          setBatchesData(prev => prev.map(item => item.id === editingItem.id ? batchItem : item));
        } else {
      ...
      case 'category':
        ...
        if (editingItem) {
          setCategoriesData(prev => prev.map(item => item.id === editingItem.id ? categoryItem : item));
        } else {
      ...
      case 'tax':
        ...
        if (editingItem) {
          setTaxData(prev => prev.map(item => item.id === editingItem.id ? taxItem : item));
        } else {
      ...
      case 'coupon':
        ...
        if (editingItem) {
          setCouponsData(prev => prev.map(item => item.id === editingItem.id ? couponItem : item));
        } else {
    ...
    toast({
      title: "Success",
      description: `${editingItem ? 'Updated' : 'Created'} ${dialogType} successfully`
    });
    ...
    switch (dialogType) {
      ...
      case 'syllabus':
        return (
          <>
            <div className="grid grid-cols-4 items-center gap-4">
              <Label htmlFor="name" className="text-right">Syllabus Name</Label>
              <Input 
                id="name" 
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              <Label htmlFor="code" className="text-right">Syllabus Code</Label>
              <Input 
                id="code" 
      ...
      case 'tax':
        return (
          <>
            <div className="grid grid-cols-4 items-center gap-4">
              <Label htmlFor="name" className="text-right">Tax Name</Label>
              <Input 
                id="name" 
      ...
      case 'coupon':
        return (
          <>
            <div className="grid grid-cols-4 items-center gap-4">
              <Label htmlFor="name" className="text-right">Coupon Code</Label>
              <Input 
                id="name" 
                ...
                <CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <Button variant="ghost" size="sm" onClick={() => openDialog('course', course)}>
                        <Edit className="w-4 h-4" />
                      </Button>
                      <Button variant="ghost" size="sm" className="text-destructive" onClick={() => handleDelete('course', course.id)}>
              ...
              <Card key={syllabus.id}>
                <CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      <Button variant="ghost" size="sm" onClick={() => openDialog('syllabus', syllabus)}>
                        <Edit className="w-4 h-4" />
                      </Button>
                      <Button variant="ghost" size="sm" className="text-destructive" onClick={() => handleDelete('syllabus', syllabus.id)}>
                        <Trash2 className="w-4 h-4" />
                      </Button>
                    </div>
                  </div>
              ...
              <Card key={batch.id}>
                <CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      <Button variant="ghost" size="sm" onClick={() => openDialog('batch', batch)}>
                        <Edit className="w-4 h-4" />
                      </Button>
                      <Button variant="ghost" size="sm" className="text-destructive" onClick={() => handleDelete('batch', batch.id)}>
                        <Trash2 className="w-4 h-4" />
                      </Button>
                    </div>
                  </div>
              ...
              <Card key={category.id}>
                <CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      <Button variant="ghost" size="sm" onClick={() => openDialog('category', category)}>
                        <Edit className="w-4 h-4" />
                      </Button>
                      <Button variant="ghost" size="sm" className="text-destructive" onClick={() => handleDelete('category', category.id)}>
                        <Trash2 className="w-4 h-4" />
                      </Button>
                    </div>
                  </div>
              ...
              <Card key={tax.id}>
                <CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      <Switch checked={tax.enabled} onCheckedChange={() => toggleTaxStatus(tax.id)} />
                      <Button variant="ghost" size="sm" onClick={() => openDialog('tax', tax)}>
                        <Edit className="w-4 h-4" />
                      </Button>
                      <Button variant="ghost" size="sm" className="text-destructive" onClick={() => handleDelete('tax', tax.id)}>
                        <Trash2 className="w-4 h-4" />
                      </Button>
                    </div>
                  </div>
                ...
                <CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <Button variant="ghost" size="sm" onClick={() => openDialog('coupon', coupon)}>
                        <Edit className="w-4 h-4" />
                      </Button>
                      <Button variant="ghost" size="sm" className="text-destructive" onClick={() => handleDelete('coupon', coupon.id)}>
                        <Trash2 className="w-4 h-4" />
                      </Button>
                    </div>
                  </div>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>{editingItem ? 'Update' : 'Create a new'} {dialogType} entry</DialogDescription>
          </DialogHeader>
